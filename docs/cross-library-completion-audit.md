...
- `zig build parley-matrix -Doptimize=ReleaseFast -- --iterations 1000 --samples
  ...
  lead by `1.332x`, `1.013x`, and `1.413x`; their inline-object counterparts
  lead by `1.131x`, `1.235x`, and `1.170x`. Arabic default and spacing
