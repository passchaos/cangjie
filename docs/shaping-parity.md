...
`5 * 11` run after specializing cached ASCII source population measured
speedups of `0.928x` on Roboto, `0.804x` on Source Serif Variable, `1.012x`
on Amiri words, `1.110x` on long Amiri text, and `0.987x` on Noto Sans
Devanagari
