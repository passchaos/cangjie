...
- NotoSansDevanagari parses and focused words `के`, `कि`, `की`, `का`,
  ...
  `अंग्रेज़ी`, `सिद्धांत`, `पुनः`, `ज़्यादा`, `सन्‌`, and `ि` pass
  `compare-harfrust`. The broader `hi-words.txt` corpus now reaches line 3684
  and is blocked at `अवार्ड्स`, a final reph ordering case.
...
- Expand the new Indic shaper slice beyond the current Devanagari `nukt`,
  ...
  stages; `hi-words.txt` is still blocked at final reph ordering in `अवार्ड्स`.
