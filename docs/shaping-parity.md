...
- RTL shaping input now classifies cluster-inheriting Arabic marks through an
  ...
  inheritance path; focused HarfBuzz `hebrew-diacritics.tests` rows
  `U+05D4,U+05B2,U+05D1,U+05B5,U+05DC` and
  `U+05E7,U+05B9,U+05D4,U+05B6,U+05DC,U+05B6,U+05EA` for
  `b895f8ff06493cc893ec44de380690ca0074edfa.ttf` are retained. Focused
...
- Expand the new Indic shaper slice beyond the current Devanagari `nukt`,
  ...
  collapse `reph + post-form + ii`. The first `ligature-id.tests` row for
  `1c2fb74c1b2aa173262734c1f616148f1648cfd6.ttf` is retained as well;
  old-spec Bengali now normalizes `virama+ra` to the `ra+virama` glyph order for
  `blwf/vatu` while preserving source-scoped `half/pres` behavior.
