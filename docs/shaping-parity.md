...
`5 * 11` run after skipping absent AAT tracking work measured speedups of
`0.925x` on Roboto, `0.821x` on Source Serif Variable, `1.021x` on Amiri
words, `1.114x` on long Amiri text, and `0.995x` on Noto Sans Devanagari
