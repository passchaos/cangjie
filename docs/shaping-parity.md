...
- NotoSansDevanagari parses and focused words `के`, `कि`, `की`, `का`,
  ...
  `अंग्रेज़ी`, `सिद्धांत`, `पुनः`, `ज़्यादा`, `सन्‌`, `ि`, and `अवार्ड्स`
  pass `compare-harfrust`. The broader `hi-words.txt` corpus now reaches line
  1128 and is blocked at `वर्ल्ड`, a conjunct plus final reph interaction.
...
- Expand the new Indic shaper slice beyond the current Devanagari `nukt`,
  ...
  stages; `hi-words.txt` is still blocked at `वर्ल्ड`.
