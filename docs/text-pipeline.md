...
The shaping-script classifier has a pinned Unicode 17
...
Regenerate the compact runtime table with:

```sh
tools/unicode/script/generate_data.py \
  path/to/Scripts.txt src/unicode/script/data.bin
```
