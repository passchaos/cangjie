//! GPOS FeatureList and ScriptList activation-graph validation.
//!
//! Lookup subtable grammar remains with the executor. This module proves that
//! every Feature table names existing lookups and that every LangSys edge names
//! an existing FeatureRecord, including ReqFeatureIndex.
