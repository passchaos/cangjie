...
const LayoutBuffer = internal_layout.LayoutBuffer;
const FontFallbackCache = internal_layout.FontFallbackCache;
const GlyphIndexCache = internal_layout.GlyphIndexCache;
const GlyphMetricsCache = internal_layout.GlyphMetricsCache;
const ShapedRunCache = internal_layout.ShapedRunCache;
const ShapePlanCache = internal_layout.ShapePlanCache;
const ShapePlanKey = internal_layout.ShapePlanKey;
const TextShaper = @import("shaping/text_shaper.zig").TextShaper;
