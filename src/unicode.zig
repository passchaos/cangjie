...
test "Imperial Aramaic text selects armi RTL script primitives" {
    ...
    try std.testing.expectEqual(@as(usize, 1), runs.len);
    try std.testing.expectEqual(Script.imperial_aramaic, runs[0].script);
    try std.testing.expectEqual(@as(usize, 0), runs[0].byte_start);
    try std.testing.expectEqual(@as(usize, text.len), runs[0].byte_len);
    try std.testing.expectEqual(OpenTypeScriptTag.armi, openTypeScriptTag(scriptForCodepoint(0x10840)));
    try std.testing.expectEqual(OpenTypeScriptTag.armi, openTypeScriptTag(scriptForCodepoint(0x10857)));
    try std.testing.expectEqual(OpenTypeScriptTag.armi, openTypeScriptTag(scriptForCodepoint(0x1085f)));
    try std.testing.expectEqual(Script.unknown, scriptForCodepoint(0x10856));
    try std.testing.expectEqual(BidiClass.rtl, bidiClassForCodepoint(0x10840));
    try std.testing.expectEqual(BidiClass.rtl, bidiClassForCodepoint(0x10858));
...
test "Meroitic Hieroglyphs select mero RTL script primitives" {
    ...
    try std.testing.expectEqual(@as(usize, 1), runs.len);
    try std.testing.expectEqual(Script.meroitic_hieroglyphs, runs[0].script);
    try std.testing.expectEqual(@as(usize, 0), runs[0].byte_start);
    try std.testing.expectEqual(@as(usize, text.len), runs[0].byte_len);
    try std.testing.expectEqual(OpenTypeScriptTag.mero, openTypeScriptTag(scriptForCodepoint(0x10980)));
    try std.testing.expectEqual(OpenTypeScriptTag.mero, openTypeScriptTag(scriptForCodepoint(0x1099f)));
    try std.testing.expectEqual(BidiClass.rtl, bidiClassForCodepoint(0x10980));
    try std.testing.expectEqual(BidiClass.rtl, bidiClassForCodepoint(0x1099f));
...
test "Meroitic Cursive selects merc RTL script primitives across assigned gaps" {
    ...
    try std.testing.expectEqual(@as(usize, 1), runs.len);
    try std.testing.expectEqual(Script.meroitic_cursive, runs[0].script);
    try std.testing.expectEqual(@as(usize, 0), runs[0].byte_start);
    try std.testing.expectEqual(@as(usize, text.len), runs[0].byte_len);
    try std.testing.expectEqual(OpenTypeScriptTag.merc, openTypeScriptTag(scriptForCodepoint(0x109a0)));
    try std.testing.expectEqual(OpenTypeScriptTag.merc, openTypeScriptTag(scriptForCodepoint(0x109bc)));
    try std.testing.expectEqual(OpenTypeScriptTag.merc, openTypeScriptTag(scriptForCodepoint(0x109ff)));
    try std.testing.expectEqual(Script.unknown, scriptForCodepoint(0x109b8));
    try std.testing.expectEqual(Script.unknown, scriptForCodepoint(0x109d0));
    try std.testing.expectEqual(BidiClass.rtl, bidiClassForCodepoint(0x109a0));
    try std.testing.expectEqual(BidiClass.rtl, bidiClassForCodepoint(0x109c0));
...
test "Arabic joining forms skip transparent marks and honor join controls" {
    ...
    try std.testing.expectEqual(JoiningType.join_causing, joiningTypeForCodepoint(0x200D)); // ZWJ
    try std.testing.expectEqual(JoiningType.non_joining, joiningTypeForCodepoint(0x200C)); // ZWNJ
    ...
    try resolveJoiningForms(&with_zwnj, &zwnj_forms);
    try std.testing.expectEqualSlices(JoiningForm, &.{ .isolated, .none, .isolated }, &zwnj_forms);
...
test "paragraph direction follows the first strong character" {
    try std.testing.expectEqual(BidiClass.rtl, try paragraphDirection("123 مرحبا"));
...
test "Grantha marks select the gran OpenType script" {
    ...
    try std.testing.expectEqual(OpenTypeScriptTag.gran, openTypeScriptTag(.grantha));
    try std.testing.expectEqual(BidiClass.ltr, bidiClassForCodepoint(0x11320));
    try std.testing.expectEqual(Script.inherited, scriptForCodepoint(0x1133b));
    try std.testing.expectEqual(Script.unknown, scriptForCodepoint(0x11304));
...
test "Kaithi syllables keep signs and select Kaithi OpenType script" {
    ...
    try std.testing.expectEqual(@as(usize, 1), runs.len);
    try std.testing.expectEqual(Script.kaithi, runs[0].script);
    try std.testing.expectEqual(@as(usize, 0), runs[0].byte_start);
    try std.testing.expectEqual(@as(usize, text.len), runs[0].byte_len);
    try std.testing.expectEqual(OpenTypeScriptTag.kthi, openTypeScriptTag(scriptForCodepoint(0x1108d)));
    try std.testing.expectEqual(OpenTypeScriptTag.kthi, openTypeScriptTag(scriptForCodepoint(0x110b3)));
    try std.testing.expectEqual(OpenTypeScriptTag.kthi, openTypeScriptTag(scriptForCodepoint(0x110bb)));
    try std.testing.expectEqual(OpenTypeScriptTag.kthi, openTypeScriptTag(scriptForCodepoint(0x110cd)));
    try std.testing.expectEqual(Script.unknown, scriptForCodepoint(0x110c3));
    try std.testing.expectEqual(BidiClass.ltr, bidiClassForCodepoint(0x1108d));
