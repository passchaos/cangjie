...
pub fn kindForCodepoint(codepoint: u21, script: Script) Kind {
    ...
    return switch (script) {
        ...
        .bamum, .mende_kikakui, .miao, .pahawh_hmong, .old_hungarian, .bhaiksuki, .siddham, .medefaidrin, .tangsa, .kawi, .warang_citi, .new_tai_lue, .soyombo, .deseret, .tulu_tigalari, .bopomofo, .masaram_gondi, .old_turkic, .dives_akuru, .osage, .tai_viet, .zanabazar_square, .nyiakeng_puachue_hmong, .vithkuqi, .garay, .kharoshthi, .ahom, .khojki, .nandinagari, .gunjala_gondi, .dogra, .wancho, .gurung_khema, .kirat_rai, .pau_cin_hau, .cypriot, .tai_yo, .tolong_siki, .caucasian_albanian, .todhri, .manichaean, .beria_erfe, .hanifi_rohingya, .carian, .ol_chiki, .shavian, .yezidi, .syloti_nagri, .ol_onal, .sunuwar, .mro, .old_permic, .nag_mundari, .sogdian, .elbasan, .nabataean, .old_sogdian, .osmanya, .mahajani, .multani, .bassa_vah, .sora_sompeng, .tai_le, .palmyrene, .toto, .inscriptional_parthian, .lycian, .psalter_pahlavi, .chorasmian, .gothic, .inscriptional_pahlavi, .lydian, .hatran, .old_uyghur, .sidetic, .makasar, .elymaic, .greek => .latin_number,
        .arabic => .arabic,
        .hebrew => .hebrew,
        .armenian => .armenian,
