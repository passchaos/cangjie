...
pub fn kindForCodepoint(codepoint: u21, script: Script) Kind {
    ...
    return switch (script) {
        ...
        .bamum, .mende_kikakui, .miao, .pahawh_hmong, .old_hungarian, .bhaiksuki, .siddham, .medefaidrin, .tangsa, .kawi, .warang_citi, .new_tai_lue, .soyombo, .deseret, .tulu_tigalari, .bopomofo, .masaram_gondi, .old_turkic, .dives_akuru => .latin_number,
        .arabic => .arabic,
        .hebrew => .hebrew,
        .armenian => .armenian,
